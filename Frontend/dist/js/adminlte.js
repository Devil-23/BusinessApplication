...
// Function to adjust cell width based on input value
const inputElements = document.querySelectorAll('input[type="text"]');
inputElements.forEach(input => {
    input.addEventListener('input', () => {
        adjustCellWidth(input);
    });
});

function adjustCellWidth(inputElement) {
    const cell = inputElement.parentElement;
    cell.style.minWidth = inputElement.scrollWidth + 'px';
}

$(document).ready(function (inputElement) {
